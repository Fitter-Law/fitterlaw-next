...
const Breadcrumbs: React.FC = () =&gt; {
  return (
    &lt;&gt;<breadcrumb pagename="Breadcrumb"><div classname="flex flex-col gap-7.5"><breadcrumbone><breadcrumbtwo><breadcrumbthree></breadcrumbthree></breadcrumbtwo></breadcrumbone></div>);
};

export default Breadcrumbs;</breadcrumb></body></html>