...
const TabTwo: React.FC = () =&gt; {
  ...
  return (<div classname="rounded-sm border-b border-stroke bg-white p-7.5 shadow-default dark:border-strokedark dark:bg-boxdark"><div classname="mb-7.5 flex flex-wrap gap-3 border-b border-stroke pb-5 dark:border-strokedark"><link 1="" href="#" classname="{`rounded-md" px-4="" py-3="" text-sm="" font-medium="" hover:bg-primary="" hover:text-white="" dark:hover:bg-primary="" md:text-base="" lg:px-6="" ${="" opentab="==" ?="" activeclasses="" :="" inactiveclasses="" }`}="" onclick="{()" =="">setOpenTab(1)}
        &gt;
...
export default TabTwo;</body></html>