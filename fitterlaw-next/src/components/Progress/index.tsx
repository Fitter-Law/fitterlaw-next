...
const Progress: React.FC = () =&gt; {
  return (&lt;&gt;<breadcrumb pagename="Progress"><div className="flex flex-col gap-7.5"><progressone><progresstwo><progressthree><progressfour></progressfour></progressthree></progresstwo></progressone></div>);
};

export default Progress;</breadcrumb>