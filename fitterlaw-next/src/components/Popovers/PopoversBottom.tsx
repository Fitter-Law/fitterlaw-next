...
const PopoversBottom: React.FC = () =&gt; {
  ...
  return (<div classname="w-full px-4 sm:w-1/2 xl:w-1/4"><div classname="mt-10 text-center sm:mb-60"><div classname="relative inline-block"><button ref="{trigger}" onclick="{()" =="">setPopoversOpen(!popoversOpen)}
            className="inline-flex rounded-md bg-primary px-5 py-2.5 font-medium text-white"
          &gt;
            Popover on Bottom</button><div ref="{popovers}" onfocus="{()" =="">setPopoversOpen(true)}
          ...
          &gt;<span classname="absolute -top-1.5 left-1/2 -z-10 h-4 w-4 -translate-x-1/2 rotate-45 rounded-sm bg-white dark:bg-meta-4"></span><div classname="border-b border-stroke p-3 dark:border-strokedark"><h4 classname="text-center text-title-sm font-semibold text-black dark:text-white">Popover Title</h4></div><div classname="px-5 py-4.5 text-center"><p classname="font-medium">Lorem ipsum dolor sit amet, consect adipiscing elit. Mauris
                facilisis congue exclamate justo nec facilisis.</p></div></div></div></div></div>);
};

export default PopoversBottom;</any></any></body></html>