...
const ColumnFilter: React.FC<columnfilterprops>= ({ column }) =&gt; {
  ...
  return (<div classname="mt-2.5 w-full"><input type="text" value="{filterValue" ||="" ""}="" onchange="{(e)" =="">setFilter(e.target.value)}
        onClick={(e) =&gt; e.stopPropagation()}
        className="w-full rounded-md border border-stroke px-3 py-1 outline-none focus:border-primary"
      /&gt;</div>);
};

export default ColumnFilter;</columnfilterprops></body></html>